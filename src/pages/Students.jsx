...
export default function Students() {
  ...
  const [students] = useState(mockStudentsList);
      ...
      <div class="flex flex-wrap justify-between items-end mb-lg gap-md">
        <div>
          ...
          <p class="font-body-md text-body-md text-on-surface-variant mt-1">
            Managing 1,248 active students across all sections.
          </p>
        </div>
        ...
        <div class="bg-surface-container-lowest p-lg rounded-xl shadow-sm border border-outline-variant/30">
          ...
          <div class="flex items-end justify-between">
            ...
            <span class="text-secondary font-label-md text-label-md flex items-center gap-1">
              +2.4% <span class="material-symbols-outlined text-[16px]">trending_up</span>
            </span>
          </div>
        </div>
        <div class="bg-surface-container-lowest p-lg rounded-xl shadow-sm border border-outline-variant/30">
          ...
          <div class="flex items-end justify-between">
            ...
            <span class="text-secondary font-label-md text-label-md flex items-center gap-1">
              +0.5% <span class="material-symbols-outlined text-[16px]">trending_up</span>
            </span>
          </div>
        </div>
        <div class="bg-surface-container-lowest p-lg rounded-xl shadow-sm border border-outline-variant/30">
          ...
          <div class="flex items-end justify-between">
            <span class="font-display-lg text-display-lg text-error">42</span>
            <span class="text-error font-label-md text-label-md flex items-center gap-1">
              -12% <span class="material-symbols-outlined text-[16px]">trending_down</span>
            </span>
          </div>
        </div>
        <div class="bg-surface-container-lowest p-lg rounded-xl shadow-sm border border-outline-variant/30">
          ...
          <div class="flex items-end justify-between">
            <span class="font-display-lg text-display-lg text-primary">15</span>
            <span class="font-label-md text-label-md text-on-surface-variant">Past 7 days</span>
          </div>
        </div>
      </div>
                  ...
                  <td class="px-lg py-md">
                    <div class="flex items-center gap-md">
                      ...
                      <div>
                        ...
                        <p class="text-xs text-on-surface-variant">ID: {st.id}</p>
                      </div>
                    </div>
                  </td>
                  <td class="px-lg py-md">
        ...
        <div class="fixed inset-0 z-50 flex justify-end bg-black/40 backdrop-blur-xs">
          <div class="w-full max-w-md bg-surface-container-lowest h-full shadow-2xl p-xl overflow-y-auto flex flex-col">
            ...
            <div class="text-center mb-lg">
              <Avatar src={selectedStudent.avatar} initials={selectedStudent.initials} size="w-24 h-24" border="mx-auto mb-md border-4 border-primary-fixed" />
              <h4 class="font-headline-md text-on-surface">{selectedStudent.name}</h4>
              <p class="text-body-md text-on-surface-variant">{selectedStudent.id}</p>
            </div>
